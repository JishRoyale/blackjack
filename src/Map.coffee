...
From: https://github.com/chenglou/data-structures
...
class Map
  ...
  getValues: () -> # Gets a list of all values in the map
    values = []
    values.push value[0] for own key, value of @_content
    return values

  getKeys: () -> # Gets a list of all of the keys in the map
    keys = []
    keys.push value[1] for own key, value of @_content
    return keys
